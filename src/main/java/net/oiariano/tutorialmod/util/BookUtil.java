...
public class BookUtil {
    ...
    public static final List<String> REGISTRY_OUT_PAGES = Lists.newArrayList(
            "Um forasteiro? Que surpresa... agradável?\n\n" +
                    "Seja bem-vindo ao nosso mundo, fazem alguns anos que o Sol parou de aparecer, ou foram décadas? O tempo já não importa mais.\n\n" +
                    "E os monstros? Ah, são apenas os",
            "moradores locais. Um pouco indisciplinados, talvez, mas quem sou eu para julgar?\n\n" +
                    "Acho que costumavam ir embora durante o dia, não que isso importe mais, então espero que você não seja do tipo que precisa de silêncio para dormir.\n\n",
            "Mas não se desespere, todos nós aqui compartilhamos do mesmo azar. Você está tão preso aqui quanto eu.\n\n" +
